#%%
from keras.layers import Dense, Dropout, Input, ReLU, Activation
...
for e in range(epochs):
    for _ in range(batch_size):
        ...
        gan.train_on_batch(noise2,y_gen)
    print("epochs: ",e)
...
#%%
noise3 = np.random.normal(loc=0,scale=1,size=[100,100])
generated_images = g.predict(noise3)
